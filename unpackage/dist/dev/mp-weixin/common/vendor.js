...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"uniapp手机商城","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 11:
/*!*****************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/store/index.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 13:
/*!************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/store/modules/cart.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/comment/lib/request.js */ 14));
var _util = _interopRequireDefault(__webpack_require__(/*! @/comment/lib/util.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  state: {
    list: [],
    //popup显示
  ...
  mutations: {
    ...
    initCartList: function initCartList(state, list) {
      state.list = list;
      _util.default.undateCartBagde(state.list.length);
    },
    //全选
    ...
    //初始化popupIndex
    initPopipIndex: function initPopipIndex(state, index) {
      state.popupIndex = index;
    },
    //加入购物车
    addGoodsToCart: function addGoodsToCart(state, goods) {
      state.list.unshift(goods);
      _util.default.updateCartBagde(state.list.length);
    },
    //清空购物车
  ...
  actions: {
    doSelectAll: function doSelectAll(_ref)


    {var commit = _ref.commit,getters = _ref.getters;
      getters.checkedAll ? commit('unselectAll') : commit('selectAll');
    },
    doDelGoods: function doDelGoods(_ref2)
    ...
    {var commit = _ref2.commit,state = _ref2.state;
      ...
      uni.showModal({
        ...
        success: function success(res) {
          if (res.confirm) {
            _request.default.post('/cart/delete', { //拿到选中的id切割
    ...
    //显示popup
    doShowPopup: function doShowPopup(_ref3, _ref4)





    {var state = _ref3.state,commit = _ref3.commit;var index = _ref4.index,data = _ref4.data;
    ...
    //隐藏popup
    doHidePopup: function doHidePopup(_ref5)


    {var state = _ref5.state,commit = _ref5.commit;
    ...
    //更新购物车列表
    updateCartList: function updateCartList(_ref6)


    {var state = _ref6.state,commit = _ref6.commit;
...
/***/ 14:
/*!*************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/comment/lib/request.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _index = _interopRequireDefault(__webpack_require__(/*! @/store/index.js */ 11));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} //不是引入vuex
var _default = {
  //全局配置
  common: {
    //根路径
  ...
  request: function request() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    if (options.token) {
      ...
      //二次验证,如果token验证为true(必须要token),并且token不存在
...
/***/ 15:
/*!**********************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/comment/lib/util.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  undateCartBagde: function undateCartBagde(count) {
    //设置角标
    if (count > 0) {
...
/***/ 16:
/*!************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/store/modules/path.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 17:
/*!************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/store/modules/user.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 322:
/*!*************************************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/components/uni-ui/uParse/src/libs/html2json.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 323:
/*!*************************************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/components/uni-ui/uParse/src/libs/wxDiscode.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 324:
/*!**************************************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/components/uni-ui/uParse/src/libs/htmlparser.js ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 347:
/*!***************************************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/components/uni-ui/uni-swipe-action-item/mpwxs.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _isPC = __webpack_require__(/*! ./isPC */ 348);var _default =
{
  data: function data() {
    return {
      position: [],
...
/***/ 348:
/*!**************************************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/components/uni-ui/uni-swipe-action-item/isPC.js ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 35:
/*!***************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/comment/mixin/loading.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 358:
/*!***********************************************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/components/uni-ui/mpvue-citypicker/city-data/province.js ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 359:
/*!*******************************************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/components/uni-ui/mpvue-citypicker/city-data/city.js ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 360:
/*!*******************************************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/components/uni-ui/mpvue-citypicker/city-data/area.js ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 395:
/*!***************************************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/components/uni-ui/uni-icons/icons.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!*************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/pages.json ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 76:
/*!**********************************************************************!*\
  !*** D:/鎴戠殑鏂囨。/我的文档/HBuilderProjects/uniapp手机商城/comment/lib/time.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
